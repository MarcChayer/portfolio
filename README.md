...
```sh
git clone git@github.com:MarcChayer/React-modele.git
...
On peut se baser sur React-modele pour démarrer un *nouveau* projet.

Dans les deux cas, il s'agit essentiellement de copier/coller les parties intéressantes du modèle dans le dossier du projet, sans écraser d'éventuels fichiers spécifiques. 
